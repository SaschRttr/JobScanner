"""
rohtext_holen2.py  –  Schritt 1b: Rohtext für einzelne Stellenseiten laden
===========================================================================
...
Nutzung:
  python rohtext_holen2.py             # alle offenen Stellen
  python rohtext_holen2.py --url URL   # nur eine bestimmte Stelle
  python rohtext_holen2.py --force     # auch Status 3/4/5 neu laden (Reparatur)
...
def main():
    ...
    print("\n" + "=" * 60)
    print("  ROHTEXT HOLEN 2  –  Schritt 1b: Rohtext laden")
    if args.url:
